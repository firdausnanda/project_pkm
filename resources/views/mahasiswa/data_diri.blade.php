		...
		<div class="user-profile">
			<div class="dropdown user-pro-body">
                ...
                <ul class="nav" id="side-menu">
                	<li> <a href="/mahasiswa" class="waves-effect"><i class="mdi mdi-av-timer fa-fw" data-icon="v"></i> <span class="hide-menu"> Dashboard</span></a>
                	</li>
                	<li> <a href="/data_diri" class="waves-effect active"><i class="mdi mdi-clipboard-account fa-fw"></i> <span class="hide-menu">Data Diri & Anggota</span></a>
                	</li>
