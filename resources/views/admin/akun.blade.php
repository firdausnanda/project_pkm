		...
		<div class="user-profile">
			<div class="dropdown user-pro-body">
                ...
                <ul class="nav" id="side-menu">
                	...
                	<li> <a href="#" class="waves-effect active"><i class="mdi mdi-clipboard-text fa-fw"></i> <span class="hide-menu">Akun</span></a>
                	</li>
                	<li class="devider"></li>
...
<div class="row">
	<div class="col-md-12">
		<div class="panel">
			...
			<button class="btn btn-info m-t-10"><i class="mdi mdi-account-plus fa-fw"></i> Tambah Akun</button>
			</div>
